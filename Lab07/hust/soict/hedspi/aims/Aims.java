...
public class Aims {
	...
	private static final String truncateString(String s)
	{
		if (s.length() >= 27)
	...
	private static void printMediaList() {
		if (mediaList.size() != 0) {
			for (int i = 0; i < mediaList.size(); i++) {
				System.out.printf("%d. %-30s%s\n", i + 1, truncateString(mediaList.get(i).getTitle()), mediaList.get(i).getCategory());
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		Media media3 = new DigitalVideoDisc("Alladin");
		media3.setCategory("Animation");
		media3.setCost(18.99f);
		Media book1 = new Book("Harry Potter", "Book - Fantasy Fiction", "J. K. Rowling");
		book1.setCost(20.00f);
		Media book2 = new Book("Twenty Thousand Leagues Under the Sea", "Book - Science Fiction", "Jules Verne");
		book2.setCost(25.99f);
		Media cd1 = new CompactDisc("Compact Disc 1", "CD");
		cd1.setCost(12.99f);
		Media cd2 = new CompactDisc("Compact Disc 2", "CD");
		cd1.setCost(13.99f);
